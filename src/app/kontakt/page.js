            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="bg-white/70 backdrop-blur-sm p-6 border border-gray-100/50">
                  <h3 className="text-xl font-light text-gray-800 mb-3 tracking-wide">Telefon</h3>
                ...
                <div className="bg-white/70 backdrop-blur-sm p-6 border border-gray-100/50">
                  <h3 className="text-xl font-light text-gray-800 mb-3 tracking-wide">E-mail</h3>
                  <div className="text-lg font-light text-gray-600">susanalbertsen69@gmail.com</div>
                </div>

                <div className="bg-white/70 backdrop-blur-sm p-6 border border-gray-100/50">
                  <h3 className="text-xl font-light text-gray-800 mb-3 tracking-wide">Adresse</h3>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-white/50 backdrop-blur-sm p-6 border border-gray-100/50">
                  <h4 className="text-lg font-light text-gray-800 mb-2 tracking-wide">Parkering</h4>
                  <p className="text-gray-600 font-light leading-relaxed text-sm">
                ...
                <div className="bg-white/50 backdrop-blur-sm p-6 border border-gray-100/50">
                  <h4 className="text-lg font-light text-gray-800 mb-2 tracking-wide">Faciliteter</h4>
                  <p className="text-gray-600 font-light leading-relaxed text-sm">
