  ...
  return (
    <div className="group py-12 px-8">
      <div className="space-y-8">
        ...
        <p className="text-gray-600 leading-relaxed font-light max-w-md text-sm lg:text-base">
          {description}
        </p>
        
        {/* Subtle accent line */}
        <div className="w-12 h-px bg-gradient-to-r from-gray-300 to-transparent transition-all duration-700"></div>
      </div>
    </div>
  );
};
