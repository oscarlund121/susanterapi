      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg md:text-xl font-light text-gray-600 leading-relaxed">
              ...
              og en mentaliserende tilgang. Gennem terapien lærer du at give slip på destruktive 
              følelser, fastlåsthed og overbevisninger.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 font-light leading-relaxed">
                Gennem helhjertet terapi lærer du at give slip på destruktive følelser 
                og fastlåsthed. Oplev frihed, glæde og en fornyet energi.
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 font-light leading-relaxed">
                EMDR metode til at forløse chok lagret i kroppen. Genvind balance 
                og oplevelse af ro og kærlighed.
              </p>
              <div className="w-8 h-px bg-gray-800"></div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 font-light leading-relaxed">
                Meditativ fordybelse for harmoni og balance. Kom bag om det bevidste sind 
                og oplev intens forbindelse med din sjæl.
              </p>
              <div className="w-8 h-px bg-gray-800"></div>
            </div>
          </div>
        ...
        <div className="text-center mt-16 md:mt-24">
          <div className="max-w-3xl mx-auto">
            <p className="text-lg md:text-xl font-light text-gray-600 leading-relaxed">
              I terapien kan du, dit barn, familien eller din partner få åbnet op for kroppens 
              naturlige intelligens og med lethed udfolde dine ønsker og drømme.
            </p>
          </div>
        </div>
      </div>
